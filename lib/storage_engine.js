 ...
 */
var getMongoClient = function(db, col) {
  log(db);
  log(col);
  check(db, String);
  check(col, String);
  ...
  return ViewSpot;
  // var dbConn = new MongoInternals.RemoteCollectionDriver(mongoUrl);
  // return new Mongo.Collection(col, { _driver: dbConn });
};
