...
/****************** review-restaurant-detail-begin *****************/
Router.route('/Restaurant/:id', {
  name: 'restaurantDetail',
  waitOn: function(){
    Meteor.subscribe('restaurantDetail', this.params.id);
  },
  data: function(){
    return {
      'restaurantDetail': Restaurant.findOne({"_id": new Mongo.ObjectID(this.params.id)})
    };
  }
});
/****************** review-restaurant-detail-end *****************/
...
reviewShoppingBaseController = RouteController.extend({
  ...
  shoppings : function() {
    console.log(this.findOptions().query);
    console.log(this.findOptions().limit);
...
Router.route('/Shopping/:id', {
  ...
  data: function(){
    return {
      'shoppingDetail': Shopping.findOne({"_id": new Mongo.ObjectID(this.params.id)})
    };
  }
});
/****************** review-shopping-detail-end *****************/
/**************** edit by @lyn **********************/
